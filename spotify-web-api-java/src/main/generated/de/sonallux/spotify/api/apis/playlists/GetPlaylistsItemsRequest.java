...
public class GetPlaylistsItemsRequest {
     ...
     */
    public GetPlaylistsItemsRequest(ApiClient apiClient, String playlistId) {
        this.apiClient = apiClient;
        this.request = new Request("GET", "/playlists/{playlist_id}/items")
     ...
     * @return this request
     */
    public GetPlaylistsItemsRequest market(String market) {
     ...
     * @return this request
     */
    public GetPlaylistsItemsRequest fields(String fields) {
     ...
     * @return this request
     */
    public GetPlaylistsItemsRequest limit(int limit) {
     ...
     * @return this request
     */
    public GetPlaylistsItemsRequest offset(int offset) {
     ...
     * @return this request
     */
    public GetPlaylistsItemsRequest additionalTypes(String additionalTypes) {

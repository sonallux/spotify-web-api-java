 ...
 *
 * <h3>Response</h3>
 * <p>Pages of chapters</p>
 */
public class GetAudiobookChaptersRequest {
    private static final TypeReference<Paging<SimplifiedChapter>> RESPONSE_TYPE = new TypeReference<>() {};
     ...
     */
    public GetAudiobookChaptersRequest(ApiClient apiClient, String id) {
        this.apiClient = apiClient;
        this.request = new Request("GET", "/audiobooks/{id}/chapters")
     ...
     * @return this request
     */
    public GetAudiobookChaptersRequest limit(int limit) {
     ...
     * @return this request
     */
    public GetAudiobookChaptersRequest offset(int offset) {
     ...
     */
    public ApiCall<Paging<SimplifiedChapter>> build() {

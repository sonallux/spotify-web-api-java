...
class SpotifyApiTest {
    ...
    void testCallApiAndReturnBodyError() {
        ...
        SpotifyApiException exception = assertThrows(SpotifyApiException.class, () -> api.callApiAndReturnBody(api.getTracksService().getTrack("foo")));
        assertNotNull(exception.getError());
        assertEquals(401, exception.getError().status);
    }
    ...
    void testCallApiAndReturnBody() throws SpotifyApiException {
        ...
        Artist artist = api.callApiAndReturnBody(api.getArtistsService().getArtist("foo"));
        assertNotNull(artist);
        assertEquals("0OdUWJ0sBjDrqHygGUXeCF", artist.id);
    }

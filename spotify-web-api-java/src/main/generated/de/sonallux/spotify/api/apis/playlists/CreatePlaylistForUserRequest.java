...
/**
 * <h2>Create Playlist for user request</h2>
 *
...
@Deprecated
@NullMarked
public class CreatePlaylistForUserRequest {
     ...
     */
    public CreatePlaylistForUserRequest(ApiClient apiClient, String userId, String name) {
     ...
     * @return this request
     */
    public CreatePlaylistForUserRequest _public(boolean _public) {
     ...
     * @return this request
     */
    public CreatePlaylistForUserRequest collaborative(boolean collaborative) {
     ...
     * @return this request
     */
    public CreatePlaylistForUserRequest description(String description) {
